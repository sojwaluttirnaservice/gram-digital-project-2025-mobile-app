  ...
  const pickFileAsync = async () => {
    try {
      if (mode === "image") {
        ...
        const picked = Array.isArray((res as any).assets)
          ? (res as any).assets
          : [res];
          ...
          >
            <Text className="text-base">
              {files?.length
                ...
                : placeholder ||
                  (mode === "image" ? "Choose image" : "Choose file")}
            </Text>
