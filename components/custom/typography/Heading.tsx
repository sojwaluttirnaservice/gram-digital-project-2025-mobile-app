...
export const BaseHeading: FC<BaseHeadingProps> = ({ className = "", children, defaultStyle, ...rest }) => {
...
export const H1: FC<HeadingProps> = ({ children, className, ...rest }) => (
    <BaseHeading defaultStyle="text-4xl font-bold" className={className} {...rest}>
        {children}
    </BaseHeading>
);

export const H2: FC<HeadingProps> = ({ children, className, ...rest }) => (
    <BaseHeading defaultStyle="text-3xl font-semibold" className={className} {...rest}>
        {children}
    </BaseHeading>
);

export const H3: FC<HeadingProps> = ({ children, className, ...rest }) => (
    <BaseHeading defaultStyle="text-2xl font-semibold" className={className} {...rest}>
        {children}
    </BaseHeading>
);

export const H4: FC<HeadingProps> = ({ children, className, ...rest }) => (
    <BaseHeading defaultStyle="text-xl font-medium" className={className} {...rest}>
        {children}
    </BaseHeading>
);

export const H5: FC<HeadingProps> = ({ children, className, ...rest }) => (
    <BaseHeading defaultStyle="text-lg font-medium" className={className} {...rest}>
        {children}
    </BaseHeading>
);

export const H6: FC<HeadingProps> = ({ children, className, ...rest }) => (
    <BaseHeading defaultStyle="text-base font-normal" className={className} {...rest}>
        {children}
    </BaseHeading>
);
