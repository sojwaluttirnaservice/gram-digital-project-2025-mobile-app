...
export class HttpClient {
    ...
    /** Shorthand for GET */
    get<T = any>(url: string, headers: Record<string, string> = {}): Promise<HttpResponse<T> | T> {
        return this.request<T>("GET", url, null, headers);
    }

    /** Shorthand for POST */
    post<T = any>(url: string, body: any = {}, headers: Record<string, string> = {}): Promise<HttpResponse<T> | T> {
        return this.request<T>("POST", url, body, headers);
    }

    /** Shorthand for PUT */
    put<T = any>(url: string, body: any = {}, headers: Record<string, string> = {}): Promise<HttpResponse<T> | T> {
        return this.request<T>("PUT", url, body, headers);
    }

    /** Shorthand for PATCH */
    patch<T = any>(url: string, body: any = {}, headers: Record<string, string> = {}): Promise<HttpResponse<T> | T> {
        return this.request<T>("PATCH", url, body, headers);
    }

    /** Shorthand for DELETE */
    delete<T = any>(url: string, headers: Record<string, string> = {}): Promise<HttpResponse<T> | T> {
